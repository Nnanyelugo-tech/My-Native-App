...
import { chartHeight } from "@/constants/chart";
...
export function IncomeVsExpensesChart() {
  ...
  return (
    <View className="bg-surface-card rounded-3xl p-6">
      <AppText className="text-text-primary text-base mb-8">
        Income vs Expenses
      </AppText>
      ...
      <View className="items-center justify-center mb-6 mt-4">
        <BarChart
          ...
          width={chartWidth}
        />
        <AppText className="text-text-secondary text-[10px] uppercase font-extrabold tracking-widest mt-4">
          CURRENT MONTH
        </AppText>
      </View>
